...
const DEMO_USERS = {
  employee: [
    { label: '관리자 (김민준)', email: 'admin@ilsangisang.com', password: 'admin123' },
    { label: '담당자 (이수연)', email: 'lee@ilsangisang.com', password: 'pass123' },
  ],
  client: [
    { label: '스타벅스 코리아', email: 'starbucks@client.com', password: 'client123' },
    { label: '현대자동차', email: 'hyundai@client.com', password: 'client123' },
    { label: '올리브영', email: 'oliveyoung@client.com', password: 'client123' },
  ],
};
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative space-y-6">
          ...
          <p className="text-blue-200 text-lg leading-relaxed">
            SNS, 유튜브, 네이버까지<br />
            모든 채널의 일정을 체계적으로 관리합니다.
          </p>
          <div className="flex gap-6">
            {[
              { label: '관리 클라이언트', value: '5+' },
              { label: '월 평균 콘텐츠', value: '120+' },
              { label: '담당 채널', value: '15+' },
            ].map(stat => (
              <div key={stat.label}>
