...
const ALL_CATEGORIES: Category[] = ['SNS', '유튜브', '네이버', '영상제작', '디자인제작', '기타'];
...
export default function FullSchedulePage() {
  ...
  const filtered = entries
    ...
    .filter(e =>
      !search ||
      e.keyword.includes(search) ||
      e.managerName.includes(search) ||
      e.clientName.includes(search) ||
      e.link.includes(search)
    )
          ...
          <div className="flex items-center gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder="키워드, 담당자, 클라이언트, 링크 검색..."
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-100">
                  {['#', '날짜', '담당자', '클라이언트', '카테고리', '키워드', '링크', '순위', '캡처본', '상태', '작업'].map(h => (
