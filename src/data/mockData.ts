...
export const SCHEDULE_ENTRIES: ScheduleEntry[] = [
  ...
  { id: 's_op3', date: YESTERDAY, managerId: 'u3', managerName: '박지훈', category: '네이버 여론작업', opinionTitle: '올리브영 여름 세일 기간 고객 반응 분석', opinionContent: '여름 세일 기간 동안 온라인 커뮤니티에서의 올리브영 언급량 급증. 특히 선케어 제품 관련 긍정 반응 높음.', opinionComments: '올영 세일 진짜 기다렸어 / 이번에 선크림 왕창 샀음 / 적립금 쌓으면 거의 공짜 / 앱 너무 느려요', link: 'https://search.naver.com/search.naver?query=올리브영+여름세일+후기', clientId: 'cl3', clientName: '올리브영', status: 'completed', metrics: { views: 22100, comments: 134 } },
  // Two days ago
